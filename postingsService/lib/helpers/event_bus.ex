  ...
  defmacro __using__(_opts) do
    quote do
      ...
      def start(_type, _args) do
        url = "amqp://" <> Application.get_env(:postings_management, :event_url)
        exchange = Application.get_env(:postings_management, :event_exchange)
        queue = Application.get_env(:postings_management, :event_queue)
